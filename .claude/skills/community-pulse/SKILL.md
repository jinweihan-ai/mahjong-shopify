...
description: 麻将社群舆情日报/周报:Apify 爬公开 FB 大群,品牌雷达+买家意图帖+社区热点,群单可人话增删(云端 routine 专用,v0.3)
---
...
- **卡片**(紫 header「📡 社群舆情日报 · M/D」或周报标题):KPI 三列(窗口内新帖数 | 🎯买家意图帖 | 品牌雷达+竞品命中);「📣 品牌雷达」区(命中必单列:监控词/一句摘要/情绪/[原帖](链接);无命中写"本期无");「🎯 求购线索」区逐条两行式(2026-09-03 店主定):**首行=中文一句话摘要(加粗)+ [原帖](链接) + 互动数;次行=原帖英文原文直引**(斜体,换行压成空格;超 140 词在词边界截断加"…");日报 ≤5 条、周报 ≤8 条,超出计总数;「竞品动向」一两句;「社区热点」一句话(窗口内互动最高帖;若另有争议焦点帖也点出);**报尾列当期监控群名**(来自配置表启用行,如「监控中:Mahjong Community、Mah Jongg That's It」)+水印
...
- 发送:Daily Report Bot 身份进日报群,卡片先图后,水印「📡 社群舆情 v0.3」
