...
- **现役资产**：AV 欢迎序列 4 封（live，8/10 起）；AV 弃购 3 封（live）；**评价请求 2 封（live，2026-09-13 周报实测已在发，本周 23 封带回 1 单）**；Klaviyo Reviews 已嵌产品页（累计 29 条：published 23 / rejected 6，均分 4.96）
- **列表底数（2026-09-13 更新）**：**≥425**——9/7 Charleston 发布 campaign 实发 425 人；近 15 天（8/29–9/12）新订阅 319。原「210 订阅 + 28 老客（8/11）」已作废
- **待办里程碑**：① 评价请求流转 live — **✅ 2026-09-13 确认已 live**；② 存量激活 campaign — **✅ 已发生**（9/7「AV | Launch | Charleston Garden No.8 | A/B images」发 425 人，开 58.8%、点 13.0%、11 单 $1,367.93、人均 $3.22）；③ 流内链接 UTM 核查（utm_source=klaviyo）— **仍未做，唯一敞口**，且流内邮件内容不能走 API 改（9/10 结论），须在 Klaviyo UI 核
- **campaign 实测基准（2026-09-07，首次真实群发）**：人均 $3.22、转化率 2.6%、退信 1.88%（存量名单首发挤出陈旧地址，下次群发仍 >2% 则做列表清洗）。Draft 中待发：「AV | Campaign | Monet's Garden 25% off | v1」（8/17 建，未排期）
