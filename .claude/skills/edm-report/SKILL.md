...
- **现役资产**：AV 欢迎序列 4 封（live，8/10 起）；AV 弃购 3 封（live）；评价请求 2 封（**live，8/11 起**——8/27 API 实测更正，此前基线误记为 draft）；Klaviyo Reviews 已嵌产品页（8/27 时点：13 条已发布 / 6 条已拒，其中评价流 live 后新增 3 条真实已验证 5★）
- **列表底数**：约 210 订阅 + 28 老客（8/11 时点）；转盘新增约 3 人/天
- **待办里程碑**：① ~~评价请求流转 live~~（✅ 8/27 判定完成）；② 验证期过后存量激活 campaign（210+28，文案需店主过目——8/27 时点仍为 Draft）；③ 流内链接 UTM 核查（utm_source=klaviyo）
