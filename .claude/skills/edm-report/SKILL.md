...
- **现役资产**：AV 欢迎序列 4 封（live，8/10 起）；AV 弃购 3 封（live）；评价请求 2 封（**live**，8/31 核实已转正）；Klaviyo Reviews 已嵌产品页（8/31 累计 published 14 / rejected 6，其中 7 条来自 8/24-8/30 一周）
- **列表底数**：约 210 订阅 + 28 老客（8/11 时点）→ 8/31 累计订阅估算约 360+（8/11 后净增 153）；近两周日均新增约 9 人（老基线 3 人/天 已过时）
- **转化断层（8/31 起跟踪）**：近 30 天欢迎流发出 489 封仅 1 单 $128；弃购流人均收入 $0 vs 基准 $5.81。到达率已不是瓶颈，瓶颈在「点击后到下单」，周报须持续盯这一段
- **待办里程碑**：① ~~评价请求流转 live~~ ✅ 8/31 完成；② 验证期过后存量激活 campaign（草稿「AV | Campaign | Monet's Garden 25% off | v1」8/17 建、仍 Draft，盘子已涨到约 390，文案需店主过目）；③ 流内链接 UTM 核查（utm_source=klaviyo，未见完成记录）
