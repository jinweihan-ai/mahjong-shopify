...
- **现役资产**：AV 欢迎序列 4 封（live，8/10 起）；AV 弃购 3 封（live）；评价请求 2 封（**live，9/12 日报确认已开闸**）；Klaviyo Reviews 已嵌产品页（**9/12 时点 14 条 published 全 5 星，13 条在 Monet's Garden；另 6 条 rejected**）
- **列表底数**：**9/7 campaign 实际收件 425（可作底数旁证）**；近 7 天（9/05–9/11）新订阅 213 人、昨日单日 44，已远超"转盘约 3 人/天"的旧口径——放量期底数按最近一次 campaign 收件数校准，勿再引用 8/11 的「210 订阅 + 28 老客」
- **待办里程碑**：① 评价请求流转 live —— **已完成（9/12 确认）**；② 存量激活 campaign —— `AV | Launch | Charleston Garden No. 8 | A/B images` **已于 9/07 发出**（425 收件 / 58.51% 打开 / 12.95% 点击 / 11 单 $1,367.93）；`AV | Campaign | Monet's Garden 25% off | v1` 仍 Draft，文案待店主过目，发送前每周提醒一次；③ 流内链接 UTM 核查（utm_source=klaviyo）—— 仍未核查
