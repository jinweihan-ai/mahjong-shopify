...
- **现役资产**：AV 欢迎序列 4 封（live，8/10 起）；AV 弃购 3 封（live）；**评价请求 2 封（live，flow XJNrZd，updated 8/11——2026-09-14 日报按 API 实况更正，此前本节误记为 draft）**；Klaviyo Reviews 已嵌产品页（截至 9/14 累计 14 已发布 / 6 rejected / 0 pending）
- **列表底数**：约 210 订阅 + 28 老客（8/11 时点）；转盘老基线约 3 人/天，**9/7 上新 campaign 后抬升一个量级：9/7–9/13 共 205 人（峰值 9/10 的 69，其后 44→30→20 自然衰减）**
- **待办里程碑**：① ~~评价请求流转 live~~ **✅ 已 live**（9/7–9/13 实发 23 封、打开 60.9%、2 单 $221）；② 存量激活 campaign（210+28，文案需店主过目）——**首封 campaign 已于 9/7 发出**（AV | Launch | Charleston Garden No.8 | A/B images：425 收件 / 打开 58.8% / 点击 13.0% / 11 单 $1,367.93 / 退订 1 / 举报 0），「Monet's Garden 25% off」仍 Draft，本项是否算闭环待店主定；③ 流内链接 UTM 核查（utm_source=klaviyo）
