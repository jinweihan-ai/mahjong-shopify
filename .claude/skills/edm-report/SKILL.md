...
- **现役资产**：AV 欢迎序列 4 封（live，8/10 起）；AV 弃购 3 封（live）；**评价请求 2 封（live，2026-09-22 实测近 7 天 40 封 / 打开 62.5%——此前基线误记为 draft）**；Klaviyo Reviews 已嵌产品页（2026-09-22 累计 published 25 / pending 2 / rejected 6，全 5 星）
- **列表底数**：约 210 订阅 + 28 老客（8/11 时点）。**订阅增速已三级跳（2026-09-22 实测「Subscribed to Email Marketing」日序列）：8/25–8/31 约 10/天 → 9/1–9/15 约 23/天 → 9/16–9/21 放量 71/天（6 天 425 人，与查尔斯顿预售 + KOL 抽奖窗口对齐，9/18 峰值 110）**；放量期须同步盯欢迎流打开率与退订率（新增质量会拉低互动）
- **待办里程碑**：① ~~评价请求流转 live~~ **已完成（2026-09-22 核实为 live 且在放量）**；② 验证期过后存量激活 campaign（`AV | Campaign | Monet's Garden 25% off` 仍 Draft，文案需店主过目）；③ 流内链接 UTM 核查（utm_source=klaviyo）
