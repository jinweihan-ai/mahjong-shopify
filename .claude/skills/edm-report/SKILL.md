...
- **首封真实群发已发出（2026-09-07 00:00 北京 / 9-6 09:00 美西）**：`AV | Launch | Charleston Garden No. 8 | A/B images`，425 收件 / 417 送达 / 打开 41.7% / 点击 11.3% / 10 单 $1,250.93 / 退订 1（0.24%）/ 举报 0——存量激活里程碑就此落地，"发送前每周提醒解锁项"的约定作废
- **行业基准（判分标准）**：欢迎流打开率 40-60%；弃购流人均收入基准 $5.81（Klaviyo 2026）；退订 <0.5%/封；垃圾举报 <0.1%；群发打开率 30-40% 为起步期合格带
- **现役资产**：AV 欢迎序列 4 封（live，8/10 起）；AV 弃购 3 封（live）；评价请求 2 封（live，8/11 起）；Klaviyo Reviews 已嵌产品页，**published 14 条 / rejected 6（9/7 时点，均 5★ 除一条 4★）**；旧 Welcome Series - Standard 仍 draft，不入基线
- **列表底数**：Email List 479（9/7 时点，8/11 时点约 210+28）；预售期新增提速到 24-27 人/天（此前转盘约 3-10 人/天），周新增 100（8/31-9/6）
- **待办里程碑**：① 评价请求流转 live ✅ 已完成；② 存量激活 campaign ✅ 2026-09-07 落地；③ 流内链接 UTM 核查（utm_source=klaviyo）**仍未核**——邮件已确定产出真金收入，无 UTM 会被 GA4/经营日报算成直接流量，每周报必须点名直到核完
- **口径缺口**：本环境无 Shopify 凭据，周报第 3 项「邮件归因收入 vs 店铺总收入占比」暂算不出，须在报告里显式说明而非略过
- **季节节点预警**（提前 3 周提醒）：查尔斯顿预售 9/6 开启、9/13 全平台开售、9/21 恢复正价——预售窗口内周报须跟第二封群发的排期与受众切法；BFCM 预热 11 月初、主战 11/27-11/30——10 月中旬起周报须含 BFCM 邮件计划段
