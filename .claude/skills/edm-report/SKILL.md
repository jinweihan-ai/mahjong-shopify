...
- **现役资产**：AV 欢迎序列 4 封（live，8/10 起）；AV 弃购 3 封（live）；**评价请求 2 封（live，9/2 日报确认已开闸）**；Klaviyo Reviews 已嵌产品页（**累计 20 条已发布 / 6 条 rejected，均分 4.95，9/2 时点**）
- **列表底数**：约 210 订阅 + 28 老客（8/11 时点）；转盘新增近 7 天均约 8.6 人/天（8/26-9/1，非早期的 3 人/天）
- **待办里程碑**：① ~~评价请求流转 live~~ ✅ 已结案（9/2 确认 live 且已产出真实评价）；② 存量激活 campaign（210+28，文案需店主过目）——Klaviyo 内已备 2 个 draft：「Monet's Garden 25% off」（8/17 建）、「Charleston Garden No.8 A/B images」（8/31 建），均 0 发送；③ 流内链接 UTM 核查（utm_source=klaviyo）
