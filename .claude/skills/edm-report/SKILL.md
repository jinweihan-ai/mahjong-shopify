...
- **现役资产**：AV 欢迎序列 4 封（live，8/10 起）；AV 弃购 3 封（live）；评价请求 2 封（**live**，9/1 拉取确认已开闸）；Klaviyo Reviews 已嵌产品页（9/1 时点累计 published 20 / rejected 6 / pending 0）
- **列表底数**：约 210 订阅 + 28 老客（8/11 时点）；转盘新增约 3 人/天
- **待办里程碑**：① ~~评价请求流转 live~~ ✅ 已完成（9/1 确认 live，近 7 日发 17 封／打开 70.6%／点击 23.5%，三流最优）；② 验证期过后存量激活 campaign（210+28，文案需店主过目）——仍全部 Draft，Labor Day 9/1 窗口已错过，下一硬窗口 BFCM 预热；③ 流内链接 UTM 核查（utm_source=klaviyo）
- **待观察**：近 7 日 299 封／176 开／38 点击，但 Placed Order 归因 0 单 $0——卡点疑在点击后的承接（落地页/优惠力度），非到达率
