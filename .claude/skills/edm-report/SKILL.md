...
- **现役资产**：AV 欢迎序列 4 封（live，8/10 起）；AV 弃购 3 封（live）；评价请求 2 封（**live，8/11 店主拍板**）；Klaviyo Reviews 已嵌产品页——2026-09-26 时点累计 36 条评价（28 published / 2 pending / 6 rejected）
- **列表底数**：**约 1,200 人量级（2026-09-26 时点）**——近 45 天新增约 1,015 人（周桶：8/10 的 38 → 8/31 的 100 → 9/7 的 227 → 9/14 的 403 → 9/21 的 134），9/19-9/21 单日峰值 50-65 人后回落到 10-20 人/天。旧基线「约 210 订阅 + 28 老客（8/11 时点）、转盘约 3 人/天」仅作历史参照，判「零新增/异常放量」时按现量级看
- **待办里程碑**：① ~~评价请求流转 live~~（8/11 已结清）；② 验证期过后存量激活 campaign（文案需店主过目；**原「210+28」存量口径已作废，发送前须按现 1,200 人量级重新圈人群**）；③ 流内链接 UTM 核查（utm_source=klaviyo）
