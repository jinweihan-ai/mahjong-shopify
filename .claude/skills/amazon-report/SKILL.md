...
- **双品牌**：zovadros（白牌）= 莫奈套装 B0GCHWVXK9 + 麻将垫 B0G14B92XR 等（~$32）；**Averill** = Charleston B0HDCQR7LD（**在途 288、可售 0，未落仓未开售**——2026-09-02 API 实测校正，原基线"可售 288+在途 288"系双计）
- **莫奈价格机制（2026-09-03 店主说明）**：标价 $159.99；8/31 前订单显示 $149.99 系 **$10 优惠券**所致，券到期后回到标价（**非提价**）；近期又上了新券——实收以流水为准，券的生效/到期在扣费结构监察中跟踪，新券首次出现在流水时点名报一次（券名/额度/对实收影响）
...
5. 价格与券状态一句（标价 $159.99/在生效的优惠券与额度/单件实收；双价风控已解除，2026-09-03 改此口径）
