...
## 2026-08-17 竞品框架 v1.1：报告必带商品链接 + 主题标注

店主定调：**以后竞品汇报凡点名具体商品，必须紧跟商品链接**（feed 的 `product_url` 原样输出，不缩短不包装），按品牌汇总的行也要给代表款链接；消息因此变长是预期内的，不为求短省链接。周报七日新品另需标主题（取商品页 tags 与文案原文，如"万圣节哥特""星座水晶""协会联名"，不推测），用于看懂对手在切哪个送礼场景。

同期修订：
- **`available=true` ≠ 现货**：Shopify 预售品同样返回 true。点名单品须回查 tags/description 的 preorder / pre-sale / coming soon，预售标出发货期。本周报曾据此误报 Sweet Jojo 四款 MJTI 联名为"有货"（实为预售、11 月初发货）；virora Sylvaria 站内标 Coming soon 属未上市而非缺货
- **价格地板分两条线报**：全尺寸与 mini/旅行装口径分开，避免入门层小尺寸把地板监察带偏
- 飞书多维表格入库方案暂不推进（应用缺 bitable:app 权限、凭证不在云端任务配置内），报告仍走单条飞书文本

## 2026-08-17 竞品周报首期：全尺寸地板价下探，基线需修订

- 全尺寸正装地板价已非基线所写的 virora $189：Merry Mahjong「Cabana Pink Bundle」$165（全尺寸密胺、有货）与 virora Rosanelle $169（划线 $199）在售，**Averill $159.99 仍是全市场全尺寸最低，但领先幅度由 $29 收窄至 $5**。`docs/competitor-landscape-2026-08.md` 中"低于全市场地板价 $29"一句待店主确认后修订
- 提价决策相应调整建议：方案 A（莫奈 →$189.99）会使我们落到 virora $189 同档且高于 Merry $165，失去唯一性叙事；建议方案 B（查尔斯顿 $189.99 上市对照）优先，且现有 Merry/virora 两款同价带在售品可作现成对照组
- 七日新品 17 款，Mahjong Loft 独占 11 款：9 款大理石线按生辰石/婚礼/母亲节/企业礼做**礼赠场景切片**，同一牌背换主题叙事覆盖不同送礼理由；8/13 Amber Tortoiseshell $299 为该品牌首次下探 $300 以下；万圣节款 8 月中即上架，**节日季备货窗口比预期早约两个月**
- mats 品类首次并入（13 源 165 款，8/16 首抓）：中位 $75、主流带 $59-90，印证配件线立项建议；首抓入库不作趋势解读
- 抓取健康：30 源全 success；tiles 可购率 75.2%，超高端两家仍 0 可购、TML 仍半数缺货，"现货即发"钩子继续有效
