...
## 2026-09-08(一) 经营日报:单日营业额创新高 $2,926.89(24 单),但两个 SKU 海外仓同时见底

- 周报改周日后的首个日报(9/8 周二按新规发日报)。卡片主报 + 双渠道堆叠趋势图 2 条均 code=0 送达,无降级
- **需求端**:昨日(9/7 北京)独立站 $2,926.89 / 24 单 / AOV $121.95,较前日 $1,438.96(11 单)翻倍,连续 4 天爬坡;结构 **查尔斯顿 21 单 / 莫奈 3 单**;13/24 单用达人码(AVERILLMAHJ ×7、CAFEMAHJ ×3、MAHJWITHMC ×2、BBC ×1,均 15% 档 → $129.99 落到 $110.50)。本月累计(9/1–9/7)$6,396.33 / 51 单,其中 9/6–9/7 两天占 68%
- **供给端(本报核心风险)**:海外仓 USCTX4G 实数 —— 莫奈 YB759-1 可售 **15**(预留 4,在途 0,累计已发 138,基线 55)已破 20 红线;查尔斯顿 YB759-2 可售 **0**、在途 276 未落仓。站上 Shopify 库存仍显示莫奈 89 / 查尔斯顿 219,**口径漂移 74 套 / 219 套,等于在按有货卖无货**。待发 35 单(查尔斯顿 32 / 莫奈 4)全部卡在缺货,严格红线(PAID 且未开始发货 >48h)只命中 #1109($110.50,58h)
- **Amazon**:昨日(美西 9/7)0 单,近 8 天 12 单 $1,728.12(日均 1.5)→ 触发「0 单且日均 ≥1」红线;FBA 莫奈主力 TB-MDGB-2KGR 可售 26(<30 🔴)、TB-MDGB-3KGR 与白牌 HI-OINA-8H8T 均 0、垫 Cyan 断货 Blue 剩 11;**查尔斯顿 AVG-CGN8-3KGR 可售 0、在途已发运 192 / 总量 288,尚未落仓**——与 9/7 Amazon 竞品周报"查尔斯顿 $159 已可购"不一致,当时可购的 offer 现已无库存
- 退款 🟡:#1116 全额 $129.99、#1117 部分 $26.00(均 9/6 单);备注豁免表命中 #1077(张勇「正在协商沟通」),该单现已 REFUNDED,未计入红线,状态行未动(SKILL 只授权「已发货→已结」)
- 站点巡检:首页与莫奈产品页均 200,159.99 价格串在位
- 本报给出的判断(属店主/张勇决策,未动):风险不是卖不动而是**卖出去发不出**;建议确认 276 套查尔斯顿落仓 ETA,并定站上是否改挂预售提示
- 运营卫生(留待周报):Shopify 仍有 TEST-*、(Pre-Order)(副本)、SKU-01~12 定制变体共 19 个非正式变体未清理
